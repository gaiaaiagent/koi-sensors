...
description: |
  Regen Ledger v6.0 includes an update to Cosmos SDK 0.47https://github.com/cosmos/cosmos-sdk/releases/tag/v0.47.17 and the addition of Cosmwasm module.
...
url: |
  https://github.com/regen-network/regen-ledger/blob/main/docs/ledger/migrations/v6.0-migration.md
