---
title: Credit Class, Project, and Batch Management
description: |
  This tutorial covers the creation and management of credit classes, projects, and batches using the command-line interface CLI../../ledger/infrastructure/interfaces.htmlcommand-line-interface.
...
url: |
  https://github.com/regen-network/regen-ledger/blob/main/docs/tutorials/user/credit-class-project-batch-management.md
document_id: 72f52fa2b2c484ed
repository: regen-ledger
file_path: docs/tutorials/user/credit-class-project-batch-management.md
branch: main
---
...
```sh
curl -X GET -d '' -H "Content-Type: application/json" https://api.registry.regen.network/iri-gen
```
...
---
*Source: [https://github.com/regen-network/regen-ledger/blob/main/docs/tutorials/user/credit-class-project-batch-management.md](https://github.com/regen-network/regen-ledger/blob/main/docs/tutorials/user/credit-class-project-batch-management.md)*
*Indexed: 2025-08-13*
