---
title: Upgrade Guide v5.0
description: |
  This document provides guidelines for node operators upgrading from Regen Ledger v4.1 to v5.0. For a general overview of the upgrade process, please refer to Upgrade OverviewREADME.md.
...
url: |
  https://github.com/regen-network/regen-ledger/blob/main/docs/validators/upgrades/v5.0-upgrade.md
document_id: 9c7d5998761f8f53
repository: regen-ledger
file_path: docs/validators/upgrades/v5.0-upgrade.md
branch: main
---
# Upgrade Guide v5.0
...
---
*Source: [https://github.com/regen-network/regen-ledger/blob/main/docs/validators/upgrades/v5.0-upgrade.md](https://github.com/regen-network/regen-ledger/blob/main/docs/validators/upgrades/v5.0-upgrade.md)*
*Indexed: 2025-08-13*
